...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        [cell setImage:[NSString stringWithFormat:@"dingdan_item%ld",indexPath.item] title:self.sectionArr0[indexPath.item]];
        gridcell = cell;
        ...
        MyCenterCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:MyCenterCollectionCellID forIndexPath:indexPath];
        [cell setImage:[NSString stringWithFormat:@"myCenter_item%ld",indexPath.item] title:self.sectionArr2[indexPath.item] subTitle:indexPath.item ==0? @"兑换吃、查看优惠券":@""];
        gridcell = cell;
    }
    return gridcell;
}
